...
#ifndef VOYAGERTUNNEL_SWIFT_H
#define VOYAGERTUNNEL_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="VoyagerTunnel",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSObject;
@class NSData;
SWIFT_CLASS("_TtC13VoyagerTunnel20PacketTunnelProvider")
