                        ...
                        sliver: SliverReorderableList(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return _GroupSection(
                              ...
                              onAddSession: () => widget.onAddSession(group.id),
...
class _GroupSection extends StatelessWidget {
    ...
    Widget groupContent = Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildHeader(isEditingThisGroup),
          // Sessions
                ...
                children: [
                  for (var index = 0; index < group.sessionIds.length; index += 1)
                    _SessionTile(
                      ...
                      groupId: group.id,
                      label: manager.getSessionName(group.sessionIds[index], index),
  ...
  Widget _buildHeader(bool isEditingThisGroup) {
    final addColor =
